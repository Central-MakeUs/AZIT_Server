...
public interface OrderControllerDocs {
    ...
    CommonResponse<OrderCheckoutResponse> getCheckoutInfoFromCart(@CurrentMemberId Long memberId, @RequestParam List<Long> cartItemIds);
    ...
    CommonResponse<OrderCheckoutResponse> getCheckoutInfoDirect(@CurrentMemberId Long memberId, @RequestParam Long skuId, @RequestParam Integer quantity);
