...
public final class OrderPricePolicy {
    ...
    public static long calculateTotalShippingFee(List<CartItemQueryDto> items) {
    ...
    // 총 상품 금액 (정가 합계) 계산
    public static long calculateTotalProductPrice(List<CartItemQueryDto> items) {
        return items.stream()
    ...
    // 총 멤버십 할인 금액 계산
    public static long calculateTotalMembershipDiscount(List<CartItemQueryDto> items) {
        return items.stream()
